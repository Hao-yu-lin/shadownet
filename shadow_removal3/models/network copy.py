...
class Generator(nn.Module):
    ...
    def forward(self, x):
        output1 = self.patch_embed_1(x)
        output1 = self.transformblock_1(output1)
        
        output2 = self.patch_embed_2(output1)
        output2 = self.transformblock_2(output2)
        
        output3 = self.patch_embed_3(output2)
        output3 = self.transformblock_3(output3)
        
        output4 = self.patch_embed_4(output3)
        output4 = self.transformblock_4(output4)
        
        # B x embed_dims[3] x H/16 x W/16
        output4 = self.resnetblock_4(output4)
        ...
        output3 = self.resnetblock_3(output3)
        ...
        output2 = self.resnetblock_2(output2)
        ...
        output1 = self.resnetblock_1(output1)
