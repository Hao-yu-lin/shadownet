...
def parse_args():
    ...
    parser.add_argument('--result_dir', type=str, default='/home/haoyu/Desktop/partical/shadow_removal/output/img')
    parser.add_argument('--ckpt_dir', type=str, default='/home/haoyu/Desktop/partical/shadow_removal/output/ckpt')
